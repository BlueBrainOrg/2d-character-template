...
var loop_names = ["idle", "walk", "run", "climb", "spin", ]

func add_animation(sheet_path: String, dirty_anim_name: String):
	...
	var x_cells = sheet_width / cell_width
	var y_cells = sheet_height / cell_height
